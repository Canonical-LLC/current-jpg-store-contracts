...
main = do
    ...
    let marketplace = "70e60f3b5ea7153e0acc7a803e4401d44b8ed1bae1c7baaad1a62a72"
    writePlutusScript scriptnum scriptname (apiBuyScript marketplace) (buyScriptAsShortBs marketplace)
